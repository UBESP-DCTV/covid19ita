# Getting help with covid19ita

Thanks for using covid19ita. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/covid19ita/issues) to make sure the 
