  ...
  observe({
    ...
    observeEvent(input$sidebar,{
      switch(input$sidebar,
        ...
        # Terapie intensive -------------------------------------------
        "regional-partial-ts-icuve" = mod_reg_tsicuve_server("regional_partial_tsicuve"),
        "regional-partial-ts-nocritica" = mod_reg_nocritica_server("regional_partial_nocritica"),
        "azero-sitrep" = mod_azero_server("azero_sitrep"),
        ...
        # Indici principali -------------------------------------------
        "impact" = mod_ind_ita_server("20200315"),

        # Mappe -------------------------------------------------------
        "geo_spatialTot" = mod_maps_server("geo_1"),

        # Archivio analisi --------------------------------------------
        "20200415TampHosp" = mod_0415_tamponi_server("tamp_hosp"),
        "20200406MortVeneto" = mod_0406_mort_veneto_server("mort_veneto"),
        "20200405Mort" = mod_0404_magnani_server("mortality"),
        "20200331Comp" = mod_0331_server("ven_pie"),
        "20200328Tot_hosp" = mod_0328_hosp_server("tot"),
        "20200325Hosp" = mod_0325_hosp_server("hosp"),
        "20200323Picco" = mod_0323_picco_server("picco"),
        "20200321Alessandria" = mod_0320_novara_server("da_alessandria",
                                                       loc = "Alessandria",
                                                       pop = 428826
        ),
        "20200321Vercelli" = mod_0320_novara_server("da_vercelli",
                                                    loc = "Vercelli",
                                                    pop = 174904
        ),
        "20200320Novara" = mod_0320_novara_server("da_novara"),
        "20200319Veneto" = mod_0318_intensive_server("21"),
        "20200318Piemonte" = mod_0318_piemonte_server("20200318_piemonte"),
        "20200318Fvg" = mod_0318_friuli_server("20200318_fvg"),
        "20200314Veneto" = mod_0314_server("dapb")
      )
